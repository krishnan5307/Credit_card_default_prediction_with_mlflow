...
class Pipeline(Thread):
    ...
    def __init__(self, config: Configuartion ) -> None: 
        try:
            ...
            ## EXPERIMENT_DIR_NAME= experiment , EXPERIMENT_FILE_NAME= experiment.csv
    ...
    def start_data_ingestion(self) -> DataIngestionArtifact:
        try:
            data_ingestion = DataIngestion(data_ingestion_config=self.config.get_data_ingestion_config())   ## calling componennt to a variable as class initialzation
            ## defined the object of the class
            return data_ingestion.initiate_data_ingestion() ## calling function thorugh the object
        except Exception as e:
            raise CreditException(e, sys) from e
    ...
    def start_data_validation(self, data_ingestion_artifact: DataIngestionArtifact) \
        ...
        try:
            ...
            return data_validation.initiate_data_validation() ## calling function thorugh the object
        except Exception as e:
            raise CreditException(e, sys) from e
    ...
    def start_data_transformation(self,
        ...
        try:
            ...
            return data_transformation.initiate_data_transformation() ## calling function thorugh the objects
        except Exception as e:
            print(e)
    ...
    def run_pipeline(self):    
        try:
            ...
            ## class Pipeline has two variables experiment and experiment_file_path which we can call by dot . like below 
        ...
        try:
            if Pipeline.experiment.experiment_id is not None:
                ...
                if os.path.exists(Pipeline.experiment_file_path):
                    ...
                    """
                    Mode "a" (append): This mode is used when the file already exists. If the specified file exists, 
                    new data will be appended to the end of the file without overwriting the existing content. 
                    ...
                    """
                    Mode "w" (write): This mode is used when the file should be opened for writing. 
                    If the specified file exists, it will be truncated (emptied), and if it doesn't exist, 
